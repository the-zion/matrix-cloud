<template>
  <el-container class="replied-container">
    ...
    <Article mode="Replied" v-if="currentMenu === 'article'" v-bind:statistic="commentUser"
             @row-delete="rowDelete"></Article>
    <Talk mode="Replied" v-if="currentMenu === 'talk'" v-bind:statistic="commentUser" @row-delete="rowDelete"></Talk>
  </el-container>
</template>
...
function menuSelect(item) {
  ...
  router.push({name: "creation.replied", query: {menu: item.key}})
}
